...
class LazadaLoginTest(BaseCase):
    def test_cart(self):
        ...
        #tick on the choosing product
        self.click('span.next-checkbox-inner')
        self.sleep(2)
        
        #click the checkout button
        self.click('/html/body/div[2]/div/div[2]/div/div/div[1]/div[2]/div[2]/div[2]/div/div[3]/button')
        self.sleep(5)
        
        #searching another product to add to the cart