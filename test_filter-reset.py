...
class SearchTest(BaseCase):
    def test_search_valid(self):
        ...
        self.click('//*[@id="root"]/div/div[2]/div[1]/div/div[2]/div/div[3]/div[2]/div/div[1]/label[5]/span[1]')
        self.click('//*[@id="root"]/div/div[2]/div[1]/div/div[2]/div/div[4]/div[2]/div/div/label[5]/span[1]')
        self.sleep(3)
        #click on the first brand when the product pop up
     
        self.click('//*[@id="root"]/div/div[2]/div[1]/div/div[1]/div[2]/span[4]')
        self.sleep(5)