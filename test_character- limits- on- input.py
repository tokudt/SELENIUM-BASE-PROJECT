...
class LazadaLoginTest(BaseCase):
    ...
    def test_open_signup(self):
        ...
        # Choose sign up if dont have lazada account 
        self.click('span[class*="index_module_signupButton__3bfb1909"]')
        self.sleep(2) 
        
        # Enter phone number to recieve the verify code 
        self.type('input[placeholder="Please enter your phone number"]', "0293918492841948239471983193")
        self.click('label[class*="iweb-checkbox iweb-checkbox-lazada index_module_acceptCheckbox__29218978"]')
        self.sleep(1)
        self.click('div.index_module_otpText__29218978')
        self.sleep(5)