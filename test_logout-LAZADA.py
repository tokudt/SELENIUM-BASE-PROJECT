...
class LazadaLoginTest(BaseCase):
    def test_logout(self):
        ...
        self.click('button[class="iweb-button iweb-button-primary index_module_loginButton__3bfb1909 index_module_loginButton__3bfb1909"]')

        # Wait for login result (you may need to adjust this)
        self.sleep(5)
        
        self.click("#myAccountTrigger")
        self.sleep(2)  # Give time for the dropdown to appear
        self.click("#account-popup-logout")
        self.sleep(5)  # Wait for logout to complete
